...
const InsertDropdown = () => {
   ...
   return (
      <MenuButton type="dropdown" tooltip="Insert" disabled={!editor.isEditable} icon="Plus" dropdownStyle={{ minWidth: '8rem' }}>
         <DropdownMenuItem asChild>
            <MenuButton text="Blockquote" hideText={false} tooltip={false} icon="Quote" onClick={insertBlockquote} />
         </DropdownMenuItem>
         <DropdownMenuItem asChild>
            <MenuButton text="Code block" hideText={false} tooltip={false} icon="CodeBlock" onClick={insertCodeBlock} />
         </DropdownMenuItem>
         <DropdownMenuItem asChild>
