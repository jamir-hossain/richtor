...
const Resizer = () => {
   ...
   const renderResizerHandle = (cursor: string, direction: number, position: React.CSSProperties) => (
      <div className="rte-resizer__control" style={{ cursor, ...position }} onPointerDown={(event) => startResizing(event, direction)} />
   );
