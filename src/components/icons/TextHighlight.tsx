...
const IconTextHighlight = forwardRef<SVGSVGElement, LucideProps>(({ color = 'currentColor', size = 24, strokeWidth = 2, ...props }, ref) => {
   return (
      <svg ref={ref} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
         <path
...
IconTextHighlight.displayName = 'IconTextHighlight';
